...
public class DocumentController {
    ...
    public ApiResponse<GetDocumentsResponse> getAllDocuments(@RequestParam("kbId") String kbId) {
        return ApiResponse.success(documentFacadeService.getDocuments(kbId));
    }
