...
public class XPathImpl implements javax.xml.xpath.XPath {
    ...
    private XMLSecurityManager xmlSecMgr;
    private XMLSecurityPropertyManager xmlSecPropMgr;

    XPathImpl( XPathVariableResolver vr, XPathFunctionResolver fr ) {
        this(vr, fr, false, new JdkXmlFeatures(false), new XMLSecurityManager(true), new XMLSecurityPropertyManager());
    }
